...
function Footer() {
  ...
  return (
    <footer className="agro-footer">
      <div className="agro-footer-inner">
        <div className="agro-footer-col">
          <h4>{t("footerContactUs")}</h4>
          <p>Email: info@agroservicecenter.com</p>
          <p>Phone: +123 456 7890</p>
          <p>123 Agro Street, City</p>
        </div>
        <div className="agro-footer-col agro-footer-center">
        ...
        <div className="agro-footer-col agro-footer-right">
          <h4>{t("footerFollowUs")}</h4>
          <div className="agro-social-icons">
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="social-fb">
            ...
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="social-ig">
