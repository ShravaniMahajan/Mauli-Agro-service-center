const mockProducts = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Excellent yield this season! Very high germination rate.",
  ...
  // Animal Feed -> Buffalo Feed
  {
    ...
    mrp: 80,
    stock: 100,
    image: "https://5.imimg.com/data5/SELLER/Default/2021/10/XQ/TN/EZ/3295982/organic-groundnut-cake-500x500.jpg",
    rating: 4.9,
    numReviews: 67
  },
  {
